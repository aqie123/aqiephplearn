...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='管理员表用于登录' AUTO_INCREMENT=78 ;
...
(57, 'l', '12', 1, '127.0.0.1', '12', '12'),
(58, 'm', '13', 2, '127.0.0.1', '13', '13'),
(59, 'n', '14', NULL, NULL, '14', '14'),
(60, 'o', '15', NULL, NULL, '15', '15'),
(61, 'p', '16', NULL, NULL, '16', '16'),
(62, 'q', '17', NULL, NULL, '17', '17'),
(63, 'r', '18', NULL, NULL, '18', '18'),
(64, 's', '19', NULL, NULL, '19', '19'),
(74, 'test', '1', 0, '127.0.0.1', '1', '1'),
(75, 'aqie', '123456kzl', 1, '127.0.0.1', '2924811900@qq.com', '我是超级管理员'),
(76, 'aqie123', '123', 1, '127.0.0.1', '123', '123'),
(77, 'x', 'x', 2, NULL, 'x', 'x'),
(47, 'b', '2', NULL, '127.0.0.1', '2', '2'),
(48, 'c', '3', NULL, '192.168.1.101', '3', '3'),
(49, 'd', '4', NULL, '127.0.0.1', '4', '4'),
(50, 'e', '5', 1, '127.0.0.1', '5', '5'),
(51, 'f', '6', NULL, NULL, '6', '6'),
(52, 'g', '7', NULL, NULL, '7', '7'),
(53, 'h', '8', NULL, NULL, '8', '8'),
(54, 'i', '9', NULL, NULL, '9', '9'),
(55, 'j', '10', NULL, NULL, '10', '10'),
(56, 'k', '11', NULL, NULL, '11', '11');
...
(7, 'Fellings', 'Maroon 5', '网易云', 'aqie123', 1486185561, '&lt;p&gt;I got this fellings for you!&lt;/p&gt;', 14),
(2, '标题2', '作者2', '来源2', '录入者2', 456, '我是内容2', 0),
(3, '告白气球', '周杰伦', '网易云音乐', '', 0, '&lt;p&gt;&lt;img src=&quot;http://img.baidu.com/hi/jx2/j_0001.gif&quot;/&gt;&lt;/p&gt;', 13),
(4, '说好的幸福呢', '周杰伦', '网易云', 'l', 1486162482, '&lt;p&gt;开心与不开始&lt;/p&gt;', 11),
(5, '青花瓷', '周杰伦', '网易', 'aqie', 1486163350, '&lt;p&gt;你隐藏在窑烧里千年的秘密&lt;/p&gt;', 11),
(6, '烟花易冷', '周杰伦', '网易', 'm', 1486163450, '&lt;p&gt;梦偏冷辗转一生情债又几本&lt;/p&gt;', 13),
(8, '1', '1', '1', 'aqie123', 1486185649, '&lt;p&gt;11111&lt;/p&gt;', 11),
(9, '2', '2', '2', 'aqie123', 1486185978, '&lt;p&gt;2&lt;/p&gt;', 11),
(10, '3', '3', '3', 'aqie123', 1486186048, '&lt;p&gt;‘’&amp;#39;wo /&lt;/p&gt;', 11),
(11, '23', '33', '4', 'aqie123', 1486186631, '&lt;p&gt;&amp;lt;p&amp;gt;我是&amp;lt;/p&amp;gt;&lt;/p&gt;', 11),
(12, 'Fellings', 'Maroon 5', '网易云音乐', 'aqie123', 1486186868, '<p>&lt;p&gt;我是文章内容！&lt;/p&gt;</p>', 14);
...
('def', 'article', 'admin', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'article', 'admin', 'username', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'admin', 'password', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'admin', 'rights', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', '用于区分超级管理员(1)和普通管理员(2)'),
('def', 'article', 'admin', 'ip', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'admin', 'email', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'admin', 'description', 7, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'id_l', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'article', 'list', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'author', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'source', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'typer', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'time', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'content', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'article', 'list', 'typeid', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', '文章类型id'),
('def', 'article', 'type', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'article', 'type', 'typename', 2, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'hd_admin', 'adid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'hd_admin', 'username', 2, '', 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', '后台用户名'),
('def', 'blog', 'hd_admin', 'passwd', 3, '', 'NO', 'char', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(32)', '', '', 'select,insert,update,references', '后台用户密码'),
('def', 'blog', 'hd_article', 'aid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'hd_article', 'title', 2, NULL, 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', '', '', 'select,insert,update,references', '文章标题'),
('def', 'blog', 'hd_article', 'content', 3, NULL, 'YES', 'mediumtext', 16777215, 16777215, NULL, NULL, 'utf8', 'utf8_general_ci', 'mediumtext', '', '', 'select,insert,update,references', '文章内容'),
('def', 'blog', 'hd_article', 'time', 4, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', '发表时间'),
('def', 'blog', 'hd_article', 'thumb', 5, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', '缩略图'),
('def', 'blog', 'hd_article', 'intro', 6, '', 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', '', '', 'select,insert,update,references', '文章摘要'),
('def', 'blog', 'hd_article', 'click', 7, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', '点击次数'),
('def', 'blog', 'hd_article', 'istop', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', '', '', 'select,insert,update,references', '0为正常,1为置顶'),
('def', 'blog', 'hd_article', 'isdeal', 9, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', '', '', 'select,insert,update,references', '0为正常,1为进入回收站'),
('def', 'blog', 'hd_article', 'cid', 10, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', '所属栏目ID'),
('def', 'blog', 'hd_category', 'cid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'hd_category', 'cname', 2, '', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', '栏目名称'),
('def', 'blog', 'hd_category', 'keywords', 3, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', '关键字'),
('def', 'blog', 'hd_category', 'description', 4, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', '描述'),
('def', 'blog', 'hd_category', 'isoff', 5, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1) unsigned', '', '', 'select,insert,update,references', '0为正常,1为关闭'),
('def', 'blog', 'hd_comment', 'coid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'hd_comment', 'nickname', 2, '', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', '用户昵称'),
('def', 'blog', 'hd_comment', 'time', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', '评论时间'),
('def', 'blog', 'hd_comment', 'content', 4, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', '评论内容'),
('def', 'blog', 'hd_comment', 'aid', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', '所属文章ID'),
('def', 'message', 'b_user', 'idb', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'message', 'b_user', 'b_username', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '管理名'),
('def', 'message', 'b_user', 'b_password', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '管理密码'),
('def', 'message', 'guestlist', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'message', 'guestlist', 'title', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', '标题'),
('def', 'message', 'guestlist', 'content', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', '内容'),
('def', 'message', 'guestlist', 'recontent', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', '评论'),
('def', 'message', 'guestlist', 'reply', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', '是否回复'),
('def', 'message', 'guestlist', 'adddate', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', '日期'),
('def', 'message', 'guestlist', 'username', 7, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', '用户名'),
...
('def', 'test_db', 'user', 'username', 1, '', 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test_db', 'user', 'password', 2, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'test_db', 'user', 'email', 3, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'zns_ajax', 'weibo', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'zns_ajax', 'weibo', 'content', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'zns_ajax', 'weibo', 'time', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'zns_ajax', 'weibo', 'acc', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'zns_ajax', 'weibo', 'ref', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_NEXT', '0'),
('HANDLER_READ_PREV', '6'),
('HANDLER_READ_RND', '2848'),
('HANDLER_READ_RND_NEXT', '10621'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('KEY_BLOCKS_UNUSED', '22365'),
('KEY_BLOCKS_USED', '2'),
('KEY_READ_REQUESTS', '97'),
('KEY_READS', '11'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '18806'),
('UPTIME_SINCE_FLUSH_STATUS', '18806');
...
('MYISAM_MAX_SORT_FILE_SIZE', '68719476736'),
...
('THREAD_CACHE_SIZE', '8'),
('LC_MESSAGES_DIR', 'D:\\phpStudy\\MySQL\\share\\'),
('SYNC_FRM', 'ON'),
...
('GENERAL_LOG_FILE', 'D:\\phpStudy\\MySQL\\data\\aqie.log'),
('OLD_PASSWORDS', 'OFF'),
...
('UNIQUE_CHECKS', 'ON'),
('PID_FILE', 'D:\\phpStudy\\MySQL\\data\\aqie.pid'),
('VERSION', '5.5.53'),
...
('SSL_CIPHER', ''),
('OLD', 'OFF'),
('LOG_ERROR', 'D:\\phpStudy\\MySQL\\data\\aqie.err'),
('HAVE_SSL', 'DISABLED'),
('SQL_BIG_TABLES', 'OFF'),
('HOSTNAME', 'aqie'),
...
('SLOW_QUERY_LOG_FILE', 'D:\\phpStudy\\MySQL\\data\\aqie-slow.log'),
('LOG_BIN', 'OFF'),
('SSL_CA', ''),
...
('PLUGIN_DIR', 'D:\\phpStudy\\MySQL\\lib\\plugin\\'),
...
('def', 'article', 'PRIMARY', 'def', 'article', 'admin', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'article', 'PRIMARY', 'def', 'article', 'list', 'id_l', 1, NULL, NULL, NULL, NULL),
('def', 'article', 'PRIMARY', 'def', 'article', 'type', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'blog', 'PRIMARY', 'def', 'blog', 'hd_admin', 'adid', 1, NULL, NULL, NULL, NULL),
('def', 'blog', 'PRIMARY', 'def', 'blog', 'hd_article', 'aid', 1, NULL, NULL, NULL, NULL),
('def', 'blog', 'PRIMARY', 'def', 'blog', 'hd_category', 'cid', 1, NULL, NULL, NULL, NULL),
('def', 'blog', 'PRIMARY', 'def', 'blog', 'hd_comment', 'coid', 1, NULL, NULL, NULL, NULL),
('def', 'message', 'PRIMARY', 'def', 'message', 'b_user', 'idb', 1, NULL, NULL, NULL, NULL),
('def', 'message', 'PRIMARY', 'def', 'message', 'guestlist', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'test_db', 'PRIMARY', 'def', 'test_db', 'user', 'username', 1, NULL, NULL, NULL, NULL),
('def', 'zns_ajax', 'PRIMARY', 'def', 'zns_ajax', 'weibo', 'ID', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-02-04 08:18:50', '2017-02-04 08:18:50', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 16766844, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 16583439, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 16765866, 0, 0, '2017-02-04 08:18:50', NULL, NULL, NULL, '', '', NULL),
('def', 'article', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, 37, 1392, 281474976710655, 2048, 564, '2017-01-30 20:12:08', '2017-02-04 03:35:42', NULL, NULL, '', '', NULL),
('def', 'article', 'list', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 92, 1016, 281474976710655, 2048, 0, '2017-02-03 22:10:11', '2017-02-04 06:21:04', NULL, NULL, '', '', NULL),
('def', 'article', 'type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 20, 268, 281474976710655, 2048, 24, '2017-02-02 23:57:56', '2017-02-04 06:28:12', NULL, NULL, '', '', NULL),
('def', 'blog', 'hd_admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, NULL, '', '', NULL),
('def', 'blog', 'hd_article', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, NULL, '', '', NULL),
('def', 'blog', 'hd_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, NULL, '', '', NULL),
('def', 'blog', 'hd_comment', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, NULL, '', '', NULL),
('def', 'message', 'b_user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 24, 24, 281474976710655, 2048, 0, '2017-01-27 19:53:20', '2017-01-27 19:55:23', NULL, NULL, '', '', NULL),
('def', 'message', 'guestlist', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 87, 2064, 281474976710655, 2048, 44, '2016-12-17 15:53:07', '2017-01-29 02:48:39', NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2015-11-09 17:41:24', '2015-11-09 10:41:30', '2015-11-09 17:41:30', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40, 28, 1120, 281474976710655, 3072, 0, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 530, 197, 104410, 55450570411999231, 18432, 0, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1110, 9, 9990, 2533274790395903, 20480, 0, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 511, 942, 481600, 281474976710655, 21504, 0, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2015-11-09 17:41:30', '2015-11-09 10:41:30', '2015-11-09 17:41:30', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2015-11-09 17:41:27', '2015-11-09 10:41:26', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2015-11-09 17:41:27', '2015-11-09 10:41:26', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2015-11-09 17:41:28', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2015-11-09 17:41:28', '2015-11-09 10:41:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 105, 316, 281474976710655, 2048, 0, '2015-11-09 17:41:24', '2015-12-31 08:48:42', NULL, NULL, '', '', NULL),
...
('def', 'test_db', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, 44, 880, 281474976710655, 2048, 0, '2016-11-16 07:38:43', '2017-01-30 15:12:12', NULL, NULL, '', '', NULL),
('def', 'zns_ajax', 'weibo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, 36, 548, 281474976710655, 2048, 0, '2017-01-09 05:05:58', '2017-01-31 06:56:43', NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL', 'FORCE'),
...
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL', 'FORCE'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL', 'FORCE'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'MySQL AB', 'MyISAM storage engine', 'GPL', 'FORCE'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL', 'FORCE'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL', 'ON'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL', 'ON'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL', 'OFF'),
('INNODB_TRX', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB transactions', 'GPL', 'ON'),
('INNODB_LOCKS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB conflicting locks', 'GPL', 'ON'),
('INNODB_LOCK_WAITS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB which lock is blocking which', 'GPL', 'ON'),
('INNODB_CMP', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression', 'GPL', 'ON'),
('INNODB_CMP_RESET', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression; reset cumulated counts', 'GPL', 'ON'),
('INNODB_CMPMEM', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool', 'GPL', 'ON'),
('INNODB_CMPMEM_RESET', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool; reset cumulated counts', 'GPL', 'ON'),
('INNODB_BUFFER_PAGE', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Page Information', 'GPL', 'ON'),
('INNODB_BUFFER_PAGE_LRU', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Page in LRU', 'GPL', 'ON'),
('INNODB_BUFFER_POOL_STATS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50553.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Pool Statistics Information ', 'GPL', 'ON'),
('PERFORMANCE_SCHEMA', '0.1', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'Marc Alff, Oracle', 'Performance Schema', 'GPL', 'FORCE'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50553.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL', 'ON');
...
(447, 'root', 'localhost:12230', 'blog', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'article', 'utf8', 'utf8_general_ci', NULL),
('def', 'blog', 'utf8', 'utf8_general_ci', NULL),
('def', 'message', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'utf8', 'utf8_general_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'test_db', 'utf8', 'utf8_general_ci', NULL),
('def', 'zns_ajax', 'utf8', 'utf8_general_ci', NULL);
...
('def', 'article', 'admin', 0, 'article', 'PRIMARY', 1, 'id', 'A', 22, NULL, NULL, '', 'BTREE', '', ''),
('def', 'article', 'list', 0, 'article', 'PRIMARY', 1, 'id_l', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'article', 'type', 0, 'article', 'PRIMARY', 1, 'id', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_admin', 0, 'blog', 'PRIMARY', 1, 'adid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_article', 0, 'blog', 'PRIMARY', 1, 'aid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_article', 1, 'blog', 'fk_hd_article_hd_category1_idx', 1, 'cid', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_category', 0, 'blog', 'PRIMARY', 1, 'cid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_comment', 0, 'blog', 'PRIMARY', 1, 'coid', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'hd_comment', 1, 'blog', 'fk_hd_comment_hd_article_idx', 1, 'aid', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'message', 'b_user', 0, 'message', 'PRIMARY', 1, 'idb', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'message', 'guestlist', 0, 'message', 'PRIMARY', 1, 'id', 'A', 23, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'help_keyword', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', 530, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_keyword', 0, 'mysql', 'name', 1, 'name', 'A', 530, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 2, 'help_topic_id', 'A', 1110, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 511, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 511, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'test_db', 'user', 0, 'test_db', 'PRIMARY', 1, 'username', 'A', 20, NULL, NULL, '', 'BTREE', '', ''),
('def', 'zns_ajax', 'weibo', 0, 'zns_ajax', 'PRIMARY', 1, 'ID', 'A', 15, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=3153', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=696', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=6806', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=6276', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=12744', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=26886', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=656', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=640', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-02-04 08:18:51', '2017-02-04 08:18:51', NULL, 'utf8_general_ci', NULL, 'max_rows=7802', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 16766844, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2448', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 16583439, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=65280', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 16765866, 0, 0, NULL, '2017-02-04 08:18:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2515', ''),
('def', 'article', 'admin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 22, 37, 1392, 281474976710655, 2048, 564, 78, '2017-01-30 20:12:08', '2017-02-04 03:35:42', NULL, 'utf8_general_ci', NULL, '', '管理员表用于登录'),
('def', 'article', 'list', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 92, 1016, 281474976710655, 2048, 0, 13, '2017-02-03 22:10:11', '2017-02-04 06:21:04', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'article', 'type', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 12, 20, 268, 281474976710655, 2048, 24, 16, '2017-02-02 23:57:56', '2017-02-04 06:28:12', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'blog', 'hd_admin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, 'utf8_general_ci', NULL, '', '后台用户表'),
('def', 'blog', 'hd_article', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, 'utf8_general_ci', NULL, '', '文章表'),
('def', 'blog', 'hd_category', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, 'utf8_general_ci', NULL, '', '栏目表'),
('def', 'blog', 'hd_comment', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2016-11-26 05:38:37', '2016-11-26 05:38:37', NULL, 'utf8_general_ci', NULL, '', '评论表'),
('def', 'message', 'b_user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 24, 24, 281474976710655, 2048, 0, 2, '2017-01-27 19:53:20', '2017-01-27 19:55:23', NULL, 'utf8_general_ci', NULL, '', '用来存储管理员账号密码'),
('def', 'message', 'guestlist', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 23, 87, 2064, 281474976710655, 2048, 44, 29, '2016-12-17 15:53:07', '2017-01-29 02:48:39', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2015-11-09 17:41:24', '2015-11-09 10:41:30', '2015-11-09 17:41:30', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 40, 28, 1120, 281474976710655, 3072, 0, NULL, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 530, 197, 104410, 55450570411999231, 18432, 0, NULL, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1110, 9, 9990, 2533274790395903, 20480, 0, NULL, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 511, 942, 481600, 281474976710655, 21504, 0, NULL, '2015-11-09 17:41:30', '2015-11-09 10:41:30', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2015-11-09 17:41:24', '2015-11-09 10:41:24', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2015-11-09 17:41:30', '2015-11-09 10:41:30', '2015-11-09 17:41:30', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2015-11-09 17:41:26', '2015-11-09 10:41:26', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2015-11-09 17:41:27', '2015-11-09 10:41:26', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2015-11-09 17:41:29', '2015-11-09 10:41:28', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2015-11-09 17:41:27', '2015-11-09 10:41:26', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2015-11-09 17:41:28', '2015-11-09 10:41:28', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2015-11-09 17:41:28', '2015-11-09 10:41:28', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 105, 316, 281474976710655, 2048, 0, NULL, '2015-11-09 17:41:24', '2015-12-31 08:48:42', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'test_db', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 20, 44, 880, 281474976710655, 2048, 0, NULL, '2016-11-16 07:38:43', '2017-01-30 15:12:12', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'zns_ajax', 'weibo', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 15, 36, 548, 281474976710655, 2048, 0, 31, '2017-01-09 05:05:58', '2017-01-31 06:56:43', NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'article', 'PRIMARY', 'article', 'admin', 'PRIMARY KEY'),
('def', 'article', 'PRIMARY', 'article', 'list', 'PRIMARY KEY'),
('def', 'article', 'PRIMARY', 'article', 'type', 'PRIMARY KEY'),
('def', 'blog', 'PRIMARY', 'blog', 'hd_admin', 'PRIMARY KEY'),
('def', 'blog', 'PRIMARY', 'blog', 'hd_article', 'PRIMARY KEY'),
('def', 'blog', 'PRIMARY', 'blog', 'hd_category', 'PRIMARY KEY'),
('def', 'blog', 'PRIMARY', 'blog', 'hd_comment', 'PRIMARY KEY'),
('def', 'message', 'PRIMARY', 'message', 'b_user', 'PRIMARY KEY'),
('def', 'message', 'PRIMARY', 'message', 'guestlist', 'PRIMARY KEY'),
...
('def', 'test_db', 'PRIMARY', 'test_db', 'user', 'PRIMARY KEY'),
('def', 'zns_ajax', 'PRIMARY', 'zns_ajax', 'weibo', 'PRIMARY KEY');
...
CREATE TABLE IF NOT EXISTS `b_user` (
  `idb` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `b_username` varchar(45) DEFAULT NULL COMMENT '管理名',
  `b_password` varchar(45) DEFAULT NULL COMMENT '管理密码',
  PRIMARY KEY (`idb`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用来存储管理员账号密码' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `b_user`
--

INSERT INTO `b_user` (`idb`, `b_username`, `b_password`) VALUES
(1, 'admin', '123456');
...
INSERT INTO `guestlist` (`id`, `title`, `content`, `recontent`, `reply`, `adddate`, `username`) VALUES
(20, '我能加你的才是', '我是测试管理权限的的点点滴滴多多多多', '我去好神奇，怎么跑前面来了', 1, '2017-01-28', '呜呜呜呜'),
(2, '留言一', '我不会告诉你这是十五字', '我是回复', 1, '2016-12-18', '啊切'),
(3, '留言二', '我不会告诉你这是十五字', '样式测试', 0, '2016-12-18', '啊切'),
(4, '留言三', '我不会告诉你这是十五字3', '', 0, '2016-12-18', '啊切'),
(5, 'aaaaaaa', 'sssssssxscsdsccccccccccccc', '我要当管理员', 0, '2016-12-18', 'scsc'),
(7, 'sdsds', 'asaxcsdfbfgdnfn', '', 0, '2016-12-18', 'asasas'),
(8, 'x啦啦啦', '就爱看你吃kaki噢iOS次年', '我没登陆也可以提交', 1, '2016-12-19', '啊切'),
(9, '啊切123', '简单的分页留言板', '简单的留言', 0, '2016-12-19', '啊切'),
(12, '又开始写留言板了', '时间过得好快，php开始了', '好好', 1, '2017-01-28', '啊切'),
(13, 'ceshishueu', 'acadssvvvvvvvvvvvvvvvvv', '', 0, '2017-01-28', 'aaaaaaa'),
(14, '测试封装的类', 'dsdaaaaaaaaaaaaaaaaaaaaaaaaaaaa$mag-&gt;', '', 0, '2017-01-28', 'aqie1'),
(15, '测试封装的类', 'dsdaaaaaaaaaaaaaaaaaaaaaaaaaaaa&lt;html&gt; &lt;b&gt;aaa&lt;/b&gt;', '', 0, '2017-01-28', 'aqie1'),
(16, '测试封装的类', 'dsdaaaaaaaaaaaaaaaaaaaaaaaaaaaa&lt;html&gt; &lt;b&gt;aaa&lt;/b&gt;&quot;&quot;''', '', 0, '2017-01-28', 'aqie1'),
(17, '测试留言返回', '妈妈说名字长了就会特特特棒尤其是三个字的', '', 0, '2017-01-28', 'sad啊啊'),
(18, 'qqqqqqqqqqqq', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '', 0, '2017-01-28', 'qqqq'),
(21, '汪汪汪汪汪汪', '呜呜呜呜少时诵诗书所所所所所所所所', '', 0, '2017-01-28', '汪汪汪'),
(22, '我在测试一条', '师士传说VS东方闪电付付付付付付付付付付付付付', '', 0, '2017-01-28', '水水水水'),
(23, 'testtest', '111111111111111111111111111111111', '', 0, '2017-01-28', 'testtest'),
(24, '', '', '', 0, '2017-01-28', ''),
(25, '1111111111111', '111111111111111111111111', '坎坎坷坷', 1, '2017-01-28', '111111'),
(26, 'dsfsdf', 'drop database *', '', 0, '2017-01-28', 'sdfsdf'),
(27, 'asdasd', 'create database `hello`', '', 0, '2017-01-28', 'asfasf'),
(28, '我是测试', '少时诵诗书所所所所所所所所所所所所', '', 0, '2017-01-28', '事实上');
--
-- 数据库: `mysql`
--
...
('111111', '123456a', 'kkzl123456@qq.com'),
('123456', '123456a', 'kkzl123456@qq.com'),
('aqie1231', '123456a', 'kkzl123456@qq.com'),
('aaaaaaa', '', 'kkzl123456@qq.com'),
('aqie', '123', '123'),
('', '', ''),
('北京啊啊啊啊啊', '111111q', '1111111@qq.com'),
('北京啊啊啊啊啊1', '111111q', '11111111@qq.com'),
('AQIE123', '123456Q', '1111111111@qq.com'),
('AQIE去', '1q1q1q', 'kkzl123456@qq.com'),
('QQQQQQQ', 'QQQQQQ1', 'kkzl123456@qq.com'),
('啊切123', '123456a', 'kkzl123456@qq.com'),
('请问啊啊', '123456q', 'kkzl123456@qq.com'),
('请问啊啊啊', '123456q', 'kkzl123456@qq.com'),
('请问啊啊啊1', '123456q', 'kkzl123456@qq.com'),
('aqqqqq', '1234567a', 'qqqq@qq.com'),
('aqqqqqqq', '123456a', 'qaaaqqq@qq.com'),
('112我的问答', '123456a', '123@1.com'),
('1112222', '111111a', '222@qq.com'),
('11122221', '123456a', '2212@qq.com');
--
-- 数据库: `zns_ajax`
--
CREATE DATABASE `zns_ajax` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `zns_ajax`;
...
(19, '第四条数据', 1483977120, 0, 0),
(18, '第三条数据', 1483976825, 0, 0),
(17, '第二条数据', 1483976767, 0, 0),
(16, '第一条数据', 1483976755, 0, 0),
(20, '第五条数据', 1483977176, 0, 0),
(21, '第六条数据，这里把时间格式改好了', 1483988515, 0, 0),
(22, 'dd', 1484712557, 0, 0),
(23, '1', 1484712587, 0, 0),
(24, '我又回来了', 1485740446, 0, 0),
(25, 'www', 1485831400, 0, 0),
(26, '444', 1485836649, 0, 0),
(27, '//', 1485843677, 0, 0),
(28, '“”“、、“””', 1485844094, 0, 0),
(29, '', 1485845801, 0, 0),
(30, '', 1485845803, 0, 0);
