				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
					   ...
					   <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
					    ...
					    <li><a href="pwd_edit.php"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;密码修改</a></li>
	      ...
	      <div class="modal-body">
	        <form action="../admin/admin_add.php" method="post" name="addadmin" onsubmit=" return valid()">
	        	...
	        	<div class="form-group">
	        		...
	        		<input type="text" name="password" id="addpass" class="form-control" placeholder="用户名">
	        	</div>
	        	<div class="form-group">
	        		<label for="conpass">简单描述</label>
	        		<input type="text" name="description" id="conpass" class="form-control" placeholder="用户名">
	        	</div>
	        	<div class="form-group">
