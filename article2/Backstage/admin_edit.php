	 	...
	 	<div class="row">
	 		...
	 		<div class="col-md-10">
	 			...
	 			<ul class="nav nav-tabs">
	 				...
	 				<li class="active">
	 					<a href="#" role="button"  disabled="disabled">编辑用户</a>
	 				</li>
	 			</ul>
				<!-- 提交表单 -->
				<div class="container" id="adduser">	
				     ...
				     <div class="col-md-10">
				     	<!-- 可以通过get传值也可以通过隐藏的input表单传值 -->
							 <form action="../admin/admin_edit.php?id=<?php echo $id; ?>" method="post" name="editadmin" onsubmit="return valid()">
				        	<div class="form-group">
				        		<label for="addname">用户名</label>
				        		<input type="text" name="username" id="addname" class="form-control" placeholder="用户名" value = "<?php echo $username; ?>">
				        	</div>
				        	<div class="form-group">
				        		<label for="addpass">用户密码</label>
				        		<input type="text" name="password" id="addpass" class="form-control" placeholder="用户密码" value = "<?php echo $password; ?>" readonly="true">
				        	</div>
				        	<div class="form-group">
				        		<label for="details">简单描述</label>
				        		<input type="text" name="description" id="details" class="form-control" placeholder="简单描述" value = "<?php echo $description; ?>">
				        	</div>
				        	<div class="form-group">
				        		<label for="email">用户邮箱</label>
				        		<input type="text" name="email" id="email" class="form-control" placeholder="用户邮箱" value = "<?php echo $email; ?>">
				        	</div>
				        	<div class="form-group">
				        		<label>所属用户组</label>
