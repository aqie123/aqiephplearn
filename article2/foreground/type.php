...
<div id="mainbody">
    ...
    <div class="blogs">
            ...
            <div class="classification">
                <?php 
                    ...
                    while($row1 = mysqli_fetch_array($result1)){
                        if($typeid!=$row1["id"]){
                ?>
                <a href="?typeid=<?php echo $row1["id"] ?>"><span><?php echo $row1["typename"]; ?></span></a>
                <?php 
                       }else{
                         echo '<a href="?typeid='. $row1['id'].'"><span class="active">'.$row1['typename'].'</span></a>';
                       } 
                    }
        ...
        <aside>            
            <div class="search">
                <form class="searchform" method="get" action="index.php" onsubmit="return test()" name="search">
