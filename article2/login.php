<?php 
    ...
    // echo $_SESSION['isok'];
    if($_SESSION['isok'] == 'ok'){
        echo "<script>location.href = './backstage/content.php';</script>";
    }
...
<div class="box">
    ...
    <div class="m-2">
          <div class="m-2-1">
            <form action="./login/login_save.php" method="post" name="admin" onsubmit="return test()">
                <div class="m-2-2">
